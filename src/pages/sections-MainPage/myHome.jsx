        ...
        <section className="flex flex-col justify-center m-0 gap-4 h-screen">
            <p className="text-mainColor10 font-semibold text-8xl">Hey There,</p>
                ...
                <div className="flex flex-col gap-y-4">
                    ...
                    <div  onClick={() => setCurrentPage('about')} className="mt-4 cursor-pointer"><span className="p-4 border-2 border-mainColor10 text-mainColor10 rounded-xl text-xl">About me</span>
                    </div>
                </div>
