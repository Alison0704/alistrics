  ...
  return (
    <section className="flex flex-col justify-center">
      <div className="flex flex-col p-16 gap-6 bg-mainColor30 bg-opacity-5 rounded-3xl w-full">
        ...
        <div onClick={() => setCurrentPage('projects')} className="flex justify-center w-full mt-4 cursor-pointer"><span className="p-4 border-2 border-mainColor10 text-mainColor10 rounded-xl text-xl">View Projects</span>
      </div>
      </div>
    </section>
  );
