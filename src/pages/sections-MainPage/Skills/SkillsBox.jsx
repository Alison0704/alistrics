...
function SkillsBox({title,description,skills,btnName,pdfLink}) {
    ...
    return (
        <div className="flex border-t-2 border-mainColor30 flex-col bg-mainColor30 bg-opacity-5 rounded-3xl p-8 m-2 gap-4">
            ...
            <div className="h-4/5 border-opacity-30 border-mainColor30 border-dashed border-2 flex justify-center align-middle text-mainColor30 pl-6">
                <span className="buttons text-2xl text-mainColor10 opacity-100 animate-pulse">{skills[currentSkillIndex]}</span>
            </div>
            {btnName && pdfLink && (
