  ...
  return (
    <section className="flex flex-col justify-center">
        ...
        <div className="flex flex-col p-16 gap-6 bg-mainColor30 bg-opacity-15 rounded-3xl w-full">   
             ...
             <button  className="bg-transparent border-2 border-mainColor10 text-mainColor10 rounded-xl text-xl p-2"
               type="button" onClick={() => setCurrentPage('project')}>Project Page</button>
