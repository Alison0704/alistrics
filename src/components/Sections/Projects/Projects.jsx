function Projects() {
  return (
    <section className="flex flex-col justify-center">
        <p className="text-mainColor10 content-center text-8xl text-center pb-7">Projects</p>
        <div className="flex flex-col p-16 gap-6 bg-mainColor30 bg-opacity-15 rounded-3xl w-full">   
             ...
             <button className="bg-transparent border-2 border-mainColor10 text-mainColor10 rounded-xl text-xl p-2">Projects Page</button>
        </div>
    </section>
  );
}
