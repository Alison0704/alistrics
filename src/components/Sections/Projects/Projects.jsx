function Projects() {
  return (
    // TODO 
    <section className="flex flex-row p-6 gap-4 content-center m-0 h-[30vh]">
        <p className="text-mainColor30 text-5xl font-bold flex justify-center">Projects</p>
        <div className="flex flex-row p-5 gap-6 bg-mainColor30 bg-opacity-15 rounded-3xl w-full">   
